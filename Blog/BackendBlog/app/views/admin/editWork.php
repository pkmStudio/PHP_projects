   ...
   <div class="main__container">
      <section class="add-work">
         ...
         <form class="add-work__form" action="/addwork" method="POST" data-message="work">
            ...
            <input class="add-work__input" id="workTitle" name="workTitle" type="text" value="<?= $post->title?>">

            <label class="add-work__label" for="workAnons">Введите описание к работе</label>
            <input class="add-work__input" id="workAnons" name="workAnons" type="text" value="<?= $post->anons?>">
         
            <label class="add-work__label" for="workTags">Введите теги работы</label>
            <input class="add-work__input" id="workTags" name="workTags" type="text" value="<?= $post->tags?>">

            <label class="add-work__label" for="workLink">Введите ссылку на gitHub работы</label>
            <input class="add-work__input" id="workLink" name="workLink" type="text" value="<?= $post->link?>">
