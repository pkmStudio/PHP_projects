...
//    Высчитывает с какой строчки начинать отсчет
    public function get_start(): int
    {
        return ($this->current_page - 1) * $this->per_page;
    }

//    Высчитывает сколько всего страниц будет в пагинации
...
//    Возвращает HTML пагинцации с ссылками на следующие и предыдущие страницы.
